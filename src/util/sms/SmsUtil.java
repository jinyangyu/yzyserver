...
public class SmsUtil {
	...
	public static Logger logger1 = Logger.getLogger(SmsUtil.class);
	...
	static final String accessKeyId = "LTAIarp9ktXx4VgV";
	static final String accessKeySecret = "nfPqFYkCov4QyPy0CnjbBKyEjxW50O";

	public synchronized static SendSmsResponse sendSms(String templeteCode,String phone, String msg) throws ClientException {
...
//		request.setSignName("河南道行信息科技有限公司");
		...
		logger1.info("sendSmsResponse:" + sendSmsResponse.getCode() + " msg:" + sendSmsResponse.getMessage());
